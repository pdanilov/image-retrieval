...
import cbir.descriptors.classic.vocabulary_cache as cache_module
...
def test_bow_and_vlad_fit_and_encode_share_one_vocabulary_cache_entry(tmp_cache, monkeypatch):
    ...
    import cbir.descriptors.classic.bow as bow_module
    import cbir.descriptors.classic.vlad as vlad_module
    ...
    bow_vocabulary, _, _ = bow_module.fit_and_encode(inputs, k=2, seed=0)
    ...
    vlad_vocabulary, _, _ = vlad_module.fit_and_encode(inputs, k=2, seed=0)
    np.testing.assert_array_equal(bow_vocabulary.centers, vlad_vocabulary.centers)
